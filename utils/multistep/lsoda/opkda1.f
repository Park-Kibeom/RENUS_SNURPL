...
C-----------------------------------------------------------------------
 450  JCUR = 0
C      write(*,*) 'BEFOR TEST: time, h', TN, H 
...
C-----------------------------------------------------------------------
C      WRITE(*,'(E16.6, E16.6, I6, 5E16.6)') 
C     * TN, Y(1), NQ, H, ACOR(1), RHUP, RHSM, RHDN
...
C-----------------------------------------------------------------------
 500  KFLAG = KFLAG - 1
      ...
      WRITE(3,'(I5, 3ES18.6,I5,1ES18.6,1ES18.6)') 
     * 1, TN, hu, hu, NQU, ACOR(1)/R, Y(1)

!      WRITE(3,'(A, E16.8, A, E16.8, A, I2, A, E16.8, 
!     * A, E16.8, A, E16.8, A, E16.8, A, E16.8)') 
!     * ' t= ', TN, ' Y= ', Y(1), ' Q= ', NQU, ' H= ', hu, 
!     * ' LERR= ', ACOR(1)/R, ' RD= ', RHDN, ' RSM= ', RHSM, 
!     * ' RUP= ', RHUP
...
C-----------------------------------------------------------------------
 ...
 720  HOLD = H
      ...
      WRITE(1,'(I5, 3ES18.6,I5,1ES18.6,1ES18.6)') 
     * 1, TN, hu, hu, NQU, ACOR(1)/R, Y(1)

!      WRITE(1,'(10ES16.8)') 
!     * TN, h, YH(1,1), YH(1,2)*(hu/h), YH(1,3)*(hu/h)**2,
!     * YH(1,4)*(hu/h)**3, DSM, RHSM
