...
!
      ...
      dimension sigr(2),signf(2),dc(2),sigkf(2)
...
! added end      
      ...
      integer :: iounit ! 2015_04_13 . scb for SC
...
919   format(a15,1p,2e15.5)      
      ...
      !if(ih.eq.290 .and. iz.eq.7) then
      
      iounit=ih*1000+iz
      
        write(iounit, '(a)')  "=========================  Input ========================="
        write(iounit, 918) 'h(cm)', sz
        write(iounit, 919) 'D(cm)', dc(1:2)
        write(iounit, 919) 'XS_total(/cm)', sigr(1:2)
        write(iounit, 919) 'XS_nfis(/cm)', signf(1:2)
        write(iounit, 919) 'XS_kfis(/cm)', sigkf(1:2)        
        write(iounit, 918) 'XS_s12(/cm)', sigs
        write(iounit, 918) 'keff', 1.d0/reigv
      
        write(iounit, 919) 'avg_src_1', srcbal(:,1)
        write(iounit, 919) 'avg_src_2', srcbal(:,2)
        write(iounit, 919) 'avg_src_3', srcbal(:,3)
        write(iounit, 919) 'avg_src_4', srcbal(:,4)
        write(iounit, 919) 'avg_src_5', srcbal(:,5)
        write(iounit, 919) 'avg_src_6', srcbal(:,6)
      
        write(iounit, 919) 'x_src_1', srcmomx(:,1)
        write(iounit, 919) 'x_src_2', srcmomx(:,2)
        write(iounit, 919) 'x_src_3', srcmomx(:,3)
        write(iounit, 919) 'x_src_4', srcmomx(:,4)
        write(iounit, 919) 'x_src_5', srcmomx(:,5)
        write(iounit, 919) 'x_src_6', srcmomx(:,6)
      
        write(iounit, 919) 'y_src_1', srcmomy(:,1)
        write(iounit, 919) 'y_src_2', srcmomy(:,2)
        write(iounit, 919) 'y_src_3', srcmomy(:,3)
        write(iounit, 919) 'y_src_4', srcmomy(:,4)
        write(iounit, 919) 'y_src_5', srcmomy(:,5)
        write(iounit, 919) 'y_src_6', srcmomy(:,6)
      
        write(iounit, 919) 'pflx_1', pflx(:,1)
        write(iounit, 919) 'pflx_2', pflx(:,2)
        write(iounit, 919) 'pflx_3', pflx(:,3)
        write(iounit, 919) 'pflx_4', pflx(:,4)
        write(iounit, 919) 'pflx_5', pflx(:,5)
        write(iounit, 919) 'pflx_6', pflx(:,6)
      
        write(iounit, 919) 'J_in_1', cnti(:,1)
        write(iounit, 919) 'J_in_2', cnti(:,2)
        write(iounit, 919) 'J_in_3', cnti(:,3)
        write(iounit, 919) 'J_in_4', cnti(:,4)
        write(iounit, 919) 'J_in_5', cnti(:,5)
        write(iounit, 919) 'J_in_6', cnti(:,6)
...
!#endif      
      ...
      !if(ih.eq.290 .and. iz.eq.7) then
        write(iounit, '(a)')  "========================= Output ========================="
        write(iounit, 919) 'avg_phi_1', aflx(:,1)
        write(iounit, 919) 'avg_phi_2', aflx(:,2)
        write(iounit, 919) 'avg_phi_3', aflx(:,3)
        write(iounit, 919) 'avg_phi_4', aflx(:,4)
        write(iounit, 919) 'avg_phi_5', aflx(:,5)
        write(iounit, 919) 'avg_phi_6', aflx(:,6)
      
        write(iounit, 919) 'x_mom_1', xmom(:,1)
        write(iounit, 919) 'x_mom_2', xmom(:,2)
        write(iounit, 919) 'x_mom_3', xmom(:,3)
        write(iounit, 919) 'x_mom_4', xmom(:,4)
        write(iounit, 919) 'x_mom_5', xmom(:,5)
        write(iounit, 919) 'x_mom_6', xmom(:,6)
      
        write(iounit, 919) 'y_mom_1', ymom(:,1)
        write(iounit, 919) 'y_mom_2', ymom(:,2)
        write(iounit, 919) 'y_mom_3', ymom(:,3)
        write(iounit, 919) 'y_mom_4', ymom(:,4)
        write(iounit, 919) 'y_mom_5', ymom(:,5)
        write(iounit, 919) 'y_mom_6', ymom(:,6)
      
        write(iounit, 919) 'surf_phi_1', sfli(:,1)
        write(iounit, 919) 'surf_phi_2', sfli(:,2)
        write(iounit, 919) 'surf_phi_3', sfli(:,3)
        write(iounit, 919) 'surf_phi_4', sfli(:,4)
        write(iounit, 919) 'surf_phi_5', sfli(:,5)
        write(iounit, 919) 'surf_phi_6', sfli(:,6)
      
        write(iounit, 919) 'J_out_1', cnto(:,1)
        write(iounit, 919) 'J_out_2', cnto(:,2)
        write(iounit, 919) 'J_out_3', cnto(:,3)
        write(iounit, 919) 'J_out_4', cnto(:,4)
        write(iounit, 919) 'J_out_5', cnto(:,5)
        write(iounit, 919) 'J_out_6', cnto(:,6)
            
        write(iounit, 919) 'cent_phi', cpfl(:)
